...
with st.sidebar:
    ...
    st.sidebar.markdown('<div class="sidebar-brand-title">DİJİTAL KUTUP KÜLTÜR<br>EĞİTİM PLATFORMU (DAKEP)</div>', unsafe_allow_html=True)
...
""",
    ...
    with col2:
         st.image("PiriReis.jpg", width=1500)
